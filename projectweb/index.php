...
<head>
    <title>Kedai Nasi Ayam Syed</title>
...
<body onload="loadCookies()">
    <div class="header">
        <a href="#default" class="logo">Kedai Nasi Ayam Syed</a>
            ...
            <div class="row">
                ...
                <div class="column">
                    <select id="idprtype" name="prtype">
                        ...
                        <option value="beverage">Western Food</option>
                        <option value="canned">Drinks</option>
                        <option value="electronic">Malay Food</option>
                    </select>
                </div>
                <div class="column">
